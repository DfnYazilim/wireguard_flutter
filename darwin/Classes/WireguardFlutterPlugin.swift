...
public class WireguardFlutterPlugin: NSObject, FlutterPlugin {
    ...
    public func onRegister(_ registrar: FlutterPluginRegistrar){
        ...
        let messenger = registrar.messenger
        #endif
        let wireguardMethodChannel = FlutterMethodChannel(name: "com.kapo.wireguardvpnpack/wgcontrol", binaryMessenger: messenger)
        let vpnStageE = FlutterEventChannel(
      name: "com.kapo.wireguardvpnpack/wgstage", binaryMessenger: messenger)
